...
public class UnarmedAttack_2State : HeroState
{
    public UnarmedAttack_2State(ICharacter character) : base(character) { }

    public override string Name
    {
        get
        {
            return "UnarmedAttack_2State";
        }
    }
    ...
    public override void StateLoop()
    {
        ...
        {
            ownerAnimator.SetTrigger("attack_3");
        }
